...
class UsersContainer extends React.Component<
  UsersConnectedPropsType & RouteComponentProps,
  { termFromURL: string | null | undefined }
> {
  ...
  componentDidMount() {
    ...
    if (!!this.state.termFromURL) {
      ...
      this.props.getUsers(
        ...
        this.props.pageSize,
        this.props.term ? this.props.term : undefined
      );
    }
  }
  componentDidUpdate(
    prevProps: UsersConnectedPropsType & RouteComponentProps,
    prevState: { termFromURL: string | null | undefined }
  ) {
    ...
    if (prevState.termFromURL !== this.state.termFromURL) {
      ...
      this.props.setTerm(
        this.state.termFromURL ? this.state.termFromURL : null
      );
      this.props.getUsers(
        this.props.currentPage,
        this.props.pageSize,
        this.state.termFromURL ? this.state.termFromURL : undefined
      );
    }
  }
