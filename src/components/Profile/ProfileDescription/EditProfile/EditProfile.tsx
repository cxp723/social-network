...
const EditProfile: React.FC<
  PropsType & InjectedFormProps<profileFormDataType, PropsType>
> = ({
  profile,
  ...
  let contacts = Object.keys(profile.contacts).map((contact) => (
  ...
  return (
    <form className={classes.profileForm} onSubmit={handleSubmit}>
      ...
      <div className={classes.formRow}>
        <span className={classes.semiBold}>Looking for a job: </span>
        <Field
      ...
      <div className={classes.aboutMe}>
        <Field innerText="About me" name="aboutMe" component={Textarea} />
      </div>
      <div>
        <span className={classes.semiBold}>Contacts:</span>
      </div>
      ...
      <div className={classes.bottomSection}>
        {props.updateFetching ? (
          ...
          <Button.Group>
            <Button
              onClick={() => {
                updatingProfileInProcess(false);
              }}
            >
              Cancel
            </Button>
...
export default reduxForm<profileFormDataType, PropsType>({
  form: "edit-profile",
})(EditProfile);
