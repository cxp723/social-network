...
const LoginForm: React.FC<
  OwnPropsType & InjectedFormProps<FormDataType, OwnPropsType>
> = (props) => {
  return (
    <div className={classes.wrapper}>
      <div className={classes.greetingText}>
        ...
        <p>
          My name is Aleksandr Kirichenko, I'm React developer and this is my
          simple project of Social Network. Development is still in progress, so
          some pages and modules are hardcoded or just emulate interaction with
          server. For acquaintance with this application, please use guest
          account: kirichenko723@gmail.com, password: test
        </p>
      ...
      <form className={classes.loginForm} onSubmit={props.handleSubmit}>
        ...
        {props.isFetching ? (
          <Button className={classes.button} loading fluid type="submit">
            Login
          </Button>
        ) : (
          <Button className={classes.button} fluid type="submit">
            Login
          </Button>
        )}
      </form>
